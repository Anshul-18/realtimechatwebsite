  ...
  return (
    <div className='w-full h-[100vh] bg-slate-200 flex items-center justify-center'>
        <div className='w-full max-w-[500px] h-[600px] bg-white rounded-lg shadow-gray-400 shadow-lg flex flex-col'>
            ...
            >
                <h1 className='text-gray-200 font-bold text-[30px] pt-8'>Welcome to <span className='text-white'>Chatify</span></h1>
                ...
                <form className='w-full flex flex-col gap-[20px] items-center' onSubmit={handleSignUp}>
                    ...
                    <div className='w-[90%] h-[50px] border-2 border-white/20 overflow-hidden rounded-lg relative bg-white/10'>
                        <input 
                            ...
                            value={password}
                        />
                        <span className='absolute top-[10px] right-[20px] text-[19px] text-white/70 font-semibold cursor-pointer' 
                    ...
                    <button className='px-[20px] py-[10px] bg-white text-[#4f46e5] rounded-2xl text-[18px] font-semibold hover:bg-gray-100 transition-colors mt-4' 
                        disabled={loading}
                    >
                ...
                <p className='text-white/70 cursor-pointer hover:text-white mt-4' onClick={()=>navigate("/login")}>
